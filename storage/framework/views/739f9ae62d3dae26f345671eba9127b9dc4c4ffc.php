            ...
            <div class="panel panel-default card-view">
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <form action="<?php echo e(url('/provider/products/')); ?>" enctype="multipart/form-data"  method="POST">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-folder mr-10"></i><?php echo e(__("general.addNewProduct")); ?></h6>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-body overflow-hide">
                                                            ...
                                                            <div id="english-link"
                                                                 class="form-group <?php echo e($errors->has('en_price') ? ' has-error' : ''); ?>">
                                                                <label class="control-label mb-10"
                                                                       for="exampleInputuname_01"><?php echo e(__("general.price")); ?></label>
                                                                <div class="input-group">

                                                                    <input type="text" maxlength="20"
                                                                           class="form-control "
                                                                           id="exampleInputuname_01" name="en_price"
                                                                           value="<?php echo e(old('en_price')); ?>"/>
                                                            ...
                                                            <div id="arabic-link"
                                                                 class="form-group <?php echo e($errors->has('ar_price') ? ' has-error' : ''); ?>">
                                                                <label class="control-label mb-10"
                                                                       for="exampleInputuname_01"><?php echo e(__("general.price")); ?></label>
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" maxlength="20"
                                                                           ...
                                                                           value="<?php echo e(old('ar_price')); ?>"/>

                                                                </div>
                                                                <?php if($errors->has('ar_price')): ?>
                                                                    <span class="help-block">
                                                                <strong><?php echo e($errors->first('ar_price')); ?></strong>
                                                            </span>
                                                                <?php endif; ?>
                                                            </div>
