...
<head>
    ...
    <link href="<?php echo e(asset('vendors/bower_components/dropify/dist/css/dropify.min.css')); ?>" rel="stylesheet" type="text/css"/>

    <!-- Bootstrap Switches CSS -->
    <link href="<?php echo e(asset('vendors/bower_components/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css')); ?>" rel="stylesheet" type="text/css"/>
	...
	<link href="<?php echo e(asset('dist/css/style-' . session()->get('userLanguage.direction') . '.css')); ?>" rel="stylesheet" type="text/css">
    <?php else: ?>
				...
				<ul class="nav navbar-right top-nav pull-right">
                    ...
                    <li class="dropdown auth-drp" style="line-height: 66px;">
                        ...
                        <select class="selectpicker" id="setUserLanguage" data-style="btn-success btn-outline" >
                            <?php $__currentLoopData = session()->get('systemLanguages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <option value="<?php echo e($language->id); ?>" <?php if($language->id == session()->get('userLanguage.id')): ?> selected <?php endif; ?>><?php echo e($language->name); ?></option>
					...
					<li class="dropdown auth-drp">
						...
						<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown">
                            <img src=<?php if(Auth::user()->image): ?> "<?php echo e(asset(Auth::user()->image)); ?>" <?php else: ?> <?php echo e(asset("dist/img/user1.png")); ?> <?php endif; ?> alt="user_auth" class="user-auth-img img-circle"/>
                        ...
                        <div class="panel-body  pa-0">
                            <div class="profile-box">
                                <div class="profile-cover-pic" style="min-height: 296px;max-height: 296px;">
                                    <?php if(Auth::user()): ?>
                                    <img src=<?php if(Auth::user()->cover_image): ?> "<?php echo e(asset(Auth::user()->cover_image)); ?>" <?php else: ?> <?php echo e(asset("dist/img/cropper.jpg")); ?> <?php endif; ?>  style="height: 296px;width:100%;"/>
                                    <!--<div class="profile-image-overlay"></div>-->
                                    <?php elseif($order): ?>
                                        <?php if($order->provider->user->cover_image): ?>
                                    <img src=<?php if($order->provider->user->cover_image): ?> "<?php echo e(asset($order->provider->user->cover_image)); ?>" <?php else: ?> "" <?php endif; ?>  style="height: 296px;width:100%;"/>
                                        <?php endif; ?>
...
<?php $__env->startSection('footer'); ?>
    ...
    <!-- Moment JavaScript -->
    <script type="text/javascript" src="<?php echo e(asset('vendors/bower_components/moment/min/moment-with-locales.min.js')); ?>"></script>

    <!-- Bootstrap Datetimepicker JavaScript -->
    <script type="text/javascript" src="<?php echo e(asset('vendors/bower_components/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js')); ?>"></script>
    ...
    <script>
        ...
        messaging.requestPermission()
            ...
            .then(function(token) {
                ...
                var postData = {_token: "<?php echo e(csrf_token()); ?>",firebase_token:token,login_type:<?php echo e(WEB); ?>}
                $.ajax({
