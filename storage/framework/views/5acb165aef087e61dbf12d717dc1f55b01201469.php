    ...
    <header class="sp-header" style="z-index: 4;">
        ...
        <div class="form-group mb-0 pull-right">
            <span class="inline-block pr-10 brand-text-white"
                  style="/*color:black*/"><?php echo e(__("general.Don't have an account?")); ?></span>
            <a class="inline-block btn btn-info btn-success btn-rounded brand-text-white"
               href="<?php echo e(route('register')); ?>"><?php echo e(__("general.Sign Up")); ?></a>
        </div>
                                    ...
                                    <form method="POST" action="<?php echo e(route('login')); ?>">
                                        ...
                                        <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                            ...
                                            <a class="capitalize-font txt-primary block mb-10 pull-right font-12"
                                               ...
                                               href="<?php echo e(url('/reset/password')); ?>"><?php echo e(__("general.forgot password ?")); ?></a>
                                            <div class="clearfix"></div>
                                        ...
                                        <div class="form-group text-center">
                                            <button type="submit"
                                                    class="btn btn-info btn-success btn-rounded"><?php echo e(__("general.sign in")); ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
