...
<?php echo e(__("general.updateService")); ?>
        ...
        <div class="panel panel-default card-view">
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <form action="<?php echo e(url('/admin/services/' . $service->id)); ?>" enctype="multipart/form-data"  method="POST">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input type="hidden" value="<?php echo e($service->id); ?>" name="service_type_id">
                                <div class="form-body overflow-hide">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-primary pr-10 pull-left">
                                            <input id="languageAvailability" value="1" name="is_active" type="checkbox" <?php if(old('is_active')): ?> checked <?php elseif($service->is_active == SERVICE_TYPE_ACTIVE): ?> checked <?php endif; ?>>
                                ...
                                <div class="form-group <?php echo e($errors->has('services_id') ? ' has-error' : ''); ?>">
                                    ...
                                    <select class="form-control select2" name="services_id" required>
                                        <?php $__currentLoopData = $main; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="form-body overflow-hide">
                                                        <div id="english-link" class="form-group <?php echo e($errors->has('en_name') ? ' has-error' : ''); ?>">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" maxlength="20" class="form-control " id="exampleInputuname_01" name="en_name" value=<?php if(old('en_name')): ?> "<?php echo e(old('en_name')); ?>" <?php else: ?> "<?php echo e($service->translate('en')->name); ?>" <?php endif; ?> required   />
                                                            </div>
                                                        ...
                                                        <div id="english-link"
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <textarea class="form-control"
                                                                          ...
                                                                          value="<?php echo e(old('en_desc')); ?>"><?php echo e($service->translate("en")->desc); ?></textarea>
                                                        ...
                                                        <div id="arabic-link" class="form-group <?php echo e($errors->has('ar_name') ? ' has-error' : ''); ?>">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" maxlength="20" class="form-control " id="exampleInputuname_01" name="ar_name" value=<?php if(old('ar_name')): ?> "<?php echo e(old('ar_name')); ?>" <?php else: ?> "<?php echo e($service->translate('ar')->name); ?>"  <?php endif; ?> required   />
                                                            </div>
                                                        ...
                                                        <div id="arabic-link"
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <textarea class="form-control"
                                                                          ...
                                                                          value="<?php echo e(old('ar_desc')); ?>"><?php echo e($service->translate("ar")->desc); ?></textarea>
