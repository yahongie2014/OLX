...
$(function() {
    ...
    if($('#morris_area_chart').length > 0)
		...
		Morris.Area({
			...
			lineWidth:0,
			fillOpacity: 0.6,
			pointStrokeColors:['#00cbbd', '#4e9de6', '#f0c541'],
			behaveLikeLine: true,
			grid: false,
			hideHover: 'auto',
			lineColors: ['#00cbbd', '#4e9de6', '#f0c541'],
			resize: true,
			redraw: true,
			smooth: true,
	...
	if($('#morris_extra_line_chart').length > 0)
        ...
        fillOpacity: 0,
		lineWidth:2,
		pointStrokeColors:['#00cbbd', '#f0c541', '#ed6f56'],
		behaveLikeLine: true,
		grid: false,
		hideHover: 'auto',
		lineColors: ['#00cbbd', '#f0c541', '#ed6f56'],
		resize: true,
		gridTextColor:'#878787',
		gridTextFamily:"Poppins"
	...
	if($('#morris_extra_bar_chart').length > 0)
		...
		Morris.Bar({
			...
			ykeys: ['a', 'b', 'c'],
			labels: ['A', 'B', 'C'],
			barColors:['#00cbbd', '#f0c541', '#ed6f56'],
			barOpacity:.6,
			hideHover: 'auto',
			grid: false,
			resize: true,
