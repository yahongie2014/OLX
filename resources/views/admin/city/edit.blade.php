                                ...
                                <div class="form-body overflow-hide">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-primary pr-10 pull-left">
                                            <input id="languageAvailability" value="1" name="status" type="checkbox" @if(old('status')) checked @elseif($city->status == CITY_ACTIVE) checked @endif>
                                                    ...
                                                    <div class="form-body overflow-hide">
                                                        ...
                                                        <div class="form-group {{ $errors->has('language.'. $language->id) ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" maxlength="20" class="form-control " id="exampleInputuname_01" name="language[{{$language->id}}]" value=@if(old('language.'. $language->id)) {{old('language.'. $language->id)}} @elseif(isset($cityLanguages[$language->id])) "{{$cityLanguages[$language->id]->pivot->name}}" @else ""  @endif  />
                                                            </div>
