        ...
        <div class="panel panel-default card-view">
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <form action="{{url('/admin/cartypes/' . $carType->id)}}" enctype="multipart/form-data"  method="POST">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                {{ method_field('PATCH') }}
                                {{ csrf_field() }}
                                <input type="hidden" value="{{$carType->id}}" name="car_type_id">
                                <div class="form-body overflow-hide">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-primary pr-10 pull-left">
                                            <input id="languageAvailability" value="1" name="status" type="checkbox" @if(old('status')) checked @elseif($carType->status == CAR_TYPE_ACTIVE) checked @endif>
                                    ...
                                    <div class="form-group {{ $errors->has('car_type_name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" maxlength="100" class="form-control " id="exampleInputuname_01" name="car_type_name" value=@if(old('car_type_name')) "{{old('car_type_name')}}" @else "{{$carType->name}}" @endif required />
                                        </div>
                                                    ...
                                                    <div class="form-body overflow-hide">
                                                        ...
                                                        <div class="form-group {{ $errors->has('language['. $language->id .']') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" maxlength="100" class="form-control " id="exampleInputuname_01" name="language[{{$language->id}}]" value=@if(isset($carTypeLanguages[$language->id])) "{{$carTypeLanguages[$language->id]->pivot->name}}" @else ""  @endif  />
                                                            </div>
